...
namespace usb_fs {
  struct Registers {
      struct {
          ...
          union {
              __RW
              u32 HNPTXFSIZ;  // 0x028: Host non-periodic transmit FIFO size
              __RW
              u32 DIEPTXF0;  // 0x028: Device IN endpoint 0 transmit FIFO size
          };
          __RW
          u32 HNPTXSTS;  // 0x02C: Non-periodic transmit FIFO/queue status
          u32 _RESERVED0[2];
          __RW
          ...
          __RW
          u32 DIEPTXF[3];  // 0x104: Device IN endpoint 1/2/3 transmit FIFO size
      } Global;
      u32 _RESERVED0[188];
      struct {
          __RW
      ...
      struct {
          ...
          struct {
              __RW
              u32 DIEPCTL;  // 0x900 + 0x20 * I: Control
              u32 __RESERVED0;
              __RW
              u32 DIEPINT;  // 0x908 + 0x20 * I: Interrupt
              u32 __RESERVED1;
              __RW
              u32 DIEPTSIZ;  // 0x910 + 0x20 * I: Transfer size
              u32 __RESERVED2;
              __R
              u32 DTXFSTS;  // 0x918 + 0x20 * I: Transmit FIFO status
              u32 __RESERVED3;
          } InEndpoint[4];
          u32 _RESERVED4[96];
          struct {
              __RW
              u32 DOEPCTL;  // 0xB00 + 0x20 * I: Control
              u32 __RESERVED0;
              __RW
              u32 DOEPINT;  // 0xB08 + 0x20 * I: Interrupt
              u32 __RESERVED1;
              __RW
              u32 DOEPTSIZ;  // 0xB10 + 0x20 * I: Transfer size
              u32 __RESERVED2[3];
          } OutEndpoint[4];
      } Device;
      u32 _RESERVED2[160];
