...
// USART1 in a human readable way:
//
//  i       Cb(i)   Y(i)    Cr(i)   Y(i + 1)
//  0       0x80    0x00    0x80    0x00
//  2       0x80    0x00    0x80    0x00
//  ...     ...     ...     ...     ...
//
...
void interrupt::DCMI()
{
  ...
  printf("i\tCb(i)\tY(i)\tCr(i)\tY(i + 1)\n");

  for (size_t i = 0; i < sizeof(outputBuffer) / 4; i++)
