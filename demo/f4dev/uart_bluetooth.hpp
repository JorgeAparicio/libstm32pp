...
void configureDma()
{
  ...
  DMA_U3TX::setMemory0Address(&outputBuffer);
  ...
  DMA_U3RX::configure(
      ...
      dma::stream::cr::mburst::MEMORY_BURST_TRANSFER_SINGLE,
      dma::stream::cr::chsel::CHANNEL_4);
  DMA_U3RX::setMemory0Address(&inputBuffer);
  DMA_U3RX::setPeripheralAddress(&USART3_REGS->DR);
  DMA_U3RX::setNumberOfTransactions(sizeof(inputBuffer));
  DMA_U3RX::enableGlobalInterrupts();
...
void interrupt::DMA1_Stream1()
{
  ...
  DMA_U3TX::setNumberOfTransactions(sizeof(outputBuffer));
